...
import com.sbm.rcu.service.EmailService;
...
public class EmailResource {
    ...
    public ResponseEntity<EmailDTO> createEmail(@RequestBody EmailDTO emailDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/emails/" + emailDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, emailDTO.getId()))
            .body(emailDTO);
    }
    ...
    public ResponseEntity<EmailDTO> updateEmail(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, emailDTO.getId()))
            .body(emailDTO);
    }
    ...
    public ResponseEntity<EmailDTO> partialUpdateEmail(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, emailDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<EmailDTO> getEmail(@PathVariable("id") String id) {
